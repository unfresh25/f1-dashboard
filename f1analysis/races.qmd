    ...
    cursor.execute(
        """
            SELECT r.raceId, r.year, r.round, r.circuitId, r.name AS race_name,
                ...
                re.driverId, re.constructorId, re.points, re.grid, re.laps, re.milliseconds as race_time,
