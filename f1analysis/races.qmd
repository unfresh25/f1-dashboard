...
records_data['decade'] = records_data['year'].apply(lambda x: np.floor(x / 10) * 10)

plt.figure(figsize=(8, 12))
sns.boxplot(x='decade', y='race_time_in_seconds', data=records_data, palette="PRGn")
plt.title('Distribución de Tiempos de Vuelta por Década')
plt.xlabel('Década')
