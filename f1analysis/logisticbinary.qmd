...
try:
    ...
    cursor.execute(
        """
            ...
            GROUP BY scored_or_no, r.grid, r.milliseconds, r.fastestlapspeed, r.constructorid;
        """
    )
...
log_reg = sm.logit('scored_or_no ~ grid + minutes + constructorid + pit_stop + fastestlapspeed', data = records_data).fit()
```
